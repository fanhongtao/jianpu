     ...
     ((note-head-interface engraver grob source-engraver)
      ...
      (if (ly:grob-property-data grob 'stencil)
          (let* ((staff-context (ly:translator-context engraver))
                 ...
                 (key-sig (ly:context-property staff-context 'keySignature))
                 ;; for LilyPond 2.19:
                 ;; (key-sig (ly:context-property staff-context 'keyAlterations))
                 (keysig-alt-count (get-keysig-alt-count key-sig))
