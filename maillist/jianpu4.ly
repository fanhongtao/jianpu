...
\layout {
  ...
  \context { \Score \accepts StaffJianpu }
  \context { \ChoirStaff \accepts StaffJianpu }
  \context { \GrandStaff \accepts StaffJianpu }
  \context { \PianoStaff \accepts StaffJianpu }
  \context { \StaffGroup \accepts StaffJianpu }
}
